...
public class CardStackLayoutManager
        ...
        switch (s) {
            ...
            case RecyclerView.SCROLL_STATE_IDLE:
                if (state.targetPosition == RecyclerView.NO_POSITION) {
                    // What to do when Swipe is complete
                    ...
                    if (state.topPosition < state.targetPosition) {
                        ...
                        // As in the case of Next, run the next animation when the processing of the first piece is completed.
            ...
            case RecyclerView.SCROLL_STATE_DRAGGING:
                ...
                break;
            //When the card is released from your finger
    ...
    private void update(RecyclerView.Recycler recycler) {
        ...
        if (state.isSwipeCompleted()) {
            ...
            // 2. VisibleCount=1 Set to and paging when the last card is swiped
            ...
            if (direction == Direction.Right) {
                if (state.topPosition > 0) {
                    state.topPosition--;
                } /*else {
                    if (state.topPosition == 0) {
                        state.topPosition = state.lastPosition;
                    }
                }*/
            } else {
                state.topPosition++;
