...
import com.mindinventory.cardstackview.CardStackLayoutManager
...
class AutoScrollCircularPagerView @JvmOverloads constructor(
    ...
    private var isDotsRequired = true
    ...
    private fun setupAttrs(attrs: AttributeSet) {
        ...
        try {
            with(typedArray) {
                ...
                isDotsRequired = getBoolean(
                    R.styleable.AutoScrollCircularPagerView_is_dot_required,
                    true
                )
    ...
    private fun <E> setDots(items: ArrayList<E>) {
        ...
        llSliderDots.visibility = View.VISIBLE
